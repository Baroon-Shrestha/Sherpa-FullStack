...
export default function GalleryPage() {
  ...
  const gallery = [
    { src: "/sitter2.jpg", type: "image", descriptionKey: "gallery.desc1" },
    { src: "/singlesitter.jpg", type: "image", descriptionKey: "gallery.desc2" },
    { src: "/Rooms.jpeg", type: "image", descriptionKey: "gallery.desc3" },
    { src: "/room6.jpg", type: "image", descriptionKey: "gallery.desc4" },
    { src: "/room5.jpg", type: "image", descriptionKey: "gallery.desc5" },
    { src: "/room4.jpg", type: "image", descriptionKey: "gallery.desc6" },
    { src: "/room3.jpg", type: "image", descriptionKey: "gallery.desc7" },
    { src: "/room2.jpg", type: "image", descriptionKey: "gallery.desc8" },
    { src: "/room1.jpg", type: "image", descriptionKey: "gallery.desc9" },
    { src: "/washroom.jpg", type: "image", descriptionKey: "gallery.desc10" },
    { src: "/download (9).jpeg", type: "image", descriptionKey: "gallery.desc11" },
  ];
          ...
          <div className="max-w-4xl max-h-[85vh] bg-white rounded-lg shadow-xl flex flex-col overflow-hidden">
            <div className="p-4 bg-gray-100 border-b border-gray-300 flex justify-between items-center">
              <span className="font-semibold text-lg text-gray-900">
                {t("gallery.image")} {selectedIndex + 1} {t("gallery.of")}{" "}
                {gallery.length}
              </span>
            </div>
            <div className="overflow-auto p-4 flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-1/2 overflow-auto max-h-[70vh]">
                ...
                <p className="text-gray-700 text-lg leading-relaxed whitespace-pre-line">
                  {t(gallery[selectedIndex].descriptionKey)}
                </p>
              </div>
            </div>
          </div>
